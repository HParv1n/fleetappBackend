...
public class VehicleHire {
	...
	public String toString() {
		return "VehicleHire [id=" + id + ", vehicle=" + vehicle + ", vehicleid=" + vehicleid + ", dateOut=" + dateOut
				+ ", timeOut=" + timeOut + ", dateIn=" + dateIn + ", timeIn=" + timeIn + ", client=" + client
				+ ", clientid=" + clientid + ", location=" + location + ", locationid=" + locationid + ", price="
