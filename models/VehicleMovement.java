...
public class VehicleMovement {
	...
	public VehicleMovement(int id, Vehicle vehicle, int vehicleid, Location location1, int locationid1, Date date1,
			Location location2, int locationid2, Date date2, String remarks) {
		super();
		this.id = id;
	...
	public String toString() {
		return "VehicleMovement [id=" + id + ", vehicle=" + vehicle + ", vehicleid=" + vehicleid + ", location1="
				+ location1 + ", locationid1=" + locationid1 + ", date1=" + date1 + ", location2=" + location2
				+ ", locationid2=" + locationid2 + ", date2=" + date2 + ", remarks=" + remarks + "]";
	}
