...
public class VehicleMaintenance extends Auditable<String> {
	...
	public String toString() {
		return "VehicleMaintenance [id=" + id + ", vehicle=" + vehicle + ", vehicleid=" + vehicleid + ", startDate="
				+ startDate + ", endDate=" + endDate + ", price=" + price + ", supplier=" + supplier + ", supplierid="
				+ supplierid + ", remarks=" + remarks + "]";
	}
