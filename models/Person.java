...
public class Person {
	...
	public String toString() {
		return "Person [id=" + id + ", firstname=" + firstname + ", lastname=" + lastname + ", othername=" + othername
				+ ", title=" + title + ", initials=" + initials + ", socialSecurityNumber=" + socialSecurityNumber
				+ ", gender=" + gender + ", maritalStatus=" + maritalStatus + ", country=" + country + ", countryid="
				+ countryid + ", state=" + state + ", stateid=" + stateid + ", dateOfBirth=" + dateOfBirth + ", city="
				+ city + ", address=" + address + ", phone=" + phone + ", mobile=" + mobile + ", email=" + email
				+ ", photo=" + photo + "]";
	}
